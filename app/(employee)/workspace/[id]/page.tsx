...
import { createWorkspace, getComplaintByReferenceNumber, getMessagesByChatId, getWorkspaceByComplaintId, saveChat } from '@/lib/db/queries';
...
export default async function WorkspacePage({
  ...
  const complaint = await getComplaintByReferenceNumber(id);
